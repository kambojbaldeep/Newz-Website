...
export const Contact = () => {
  return (
    <form className="form" >
      ...
      <h2>Follow us</h2>
      <div>
        <a href='https://www.linkedin.com/in/baldeep-singh-kamboj' target="_blank" rel="noreferrer">
        ...
        <a href='https://instagram.com/kamboj_baldeep?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D' target="_blank" rel="noreferrer">
